    ...
    public void run() throws PersistentException {
        ...
        case "5": { // Subscribe
            ...
            do {
                ...
                if (!isDatesCorrect) System.out.println("/n Введен некорректный год подписки!");
            }
            ...
            do {
                ...
                isDatesCorrect=((month1>=1 & month2<=12 & month2>=month1) & ((month1>realMonth & tempYear==realYear) | (tempYear==++realYear)));
                
                if (!isDatesCorrect) System.out.println("/n Введены некорректные месяцы подписки на "+tempYear+" год!");
            }
            while (!isDatesCorrect);
